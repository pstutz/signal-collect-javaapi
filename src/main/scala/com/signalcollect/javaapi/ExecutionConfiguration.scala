...
import com.signalcollect.{ ExecutionConfiguration => ScalaExecutionConfiguration }
 ...
 */
object ExecutionConfiguration extends ScalaExecutionConfiguration(ExecutionMode.OptimizedAsynchronous, 0.01, 0.0, None, None)